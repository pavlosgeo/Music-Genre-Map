  ...
  return (
    <div className="side-panel">
      ...
      <div className="genre-meta">
        <span className="meta-item"><span className="meta-label">Era:</span> {genre.era}</span>
        <span className="meta-item"><span className="meta-label">Origin:</span> {genre.origin}</span>
      </div>
      ...
      <div className="genre-artists">
        ...
        <div className="artist-list">
          {genre.artists.map(a => <span key={a} className="artist-tag">{a}</span>)}
        </div>
      </div>
    </div>
  );
